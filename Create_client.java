...
public class Create_client extends Base_class {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		//
		sendkeys(pom.getPatient69().gettypefirstname(), "Jangan");
		//
		sendkeys(pom.getPatient69().gettypelastname(), "eRt");
		//
		sendkeys(pom.getPatient69().sendtypeemail(), "kadds@tedmpr.email");
		//
		sendkeys(pom.getPatient69().gettypephonenumber(), "556558544970812");
		// TODO5
		sendkeys(pom.getPatient69().geClicktId(),"5759554");
